...
print("\n")
print("Example 1") 
print("Group of persistent counters ")
...
print("Get first 3 indexes of groupID2")
print "Index 0 - 3"
key = ("test", "persistentCounter", 'groupID2')
...
print("Returned value bins will now have a tuple of return values from each OPERATION in the ops list.")
print("Expect None, None from first two increment operations, K:V pairs from next three read ops")
print(bins)
