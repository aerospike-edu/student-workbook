...
module Training
  module UserService
    ...
    def update_password(client)
      ...
      begin
        # todo: make sure the register_lua method is implemented
      ...
      begin
        # todo: call the updateUserPwd.updatePassword UDF
        self.yep
      rescue Exception => e
        self.nope
    ...
    def register_lua(client, module_path, module_name)
      # todo: register the Lua module that is locally at module_path
      # as a server UDF module named module_name
    end
